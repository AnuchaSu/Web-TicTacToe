...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="panel panel-default custom-bg-list">
                <div class="panel-body">
                        ...
                        @foreach($users as $_user)
                            <a class="list-group-item clearfix">
                                ...
                                <form action="/new-game" method="post">
                                    ...
                                    <button type="submit" class="btn_custom pull-right">Play</button>
                                </form>
                            </a>
                        @endforeach
                    </div>
